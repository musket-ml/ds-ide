...
public class NodeKind implements IPropertyProvider {
	...
	private final class MapProperty extends AbstractWritableProperty implements IProperty {

		private final String arg1;

		private MapProperty(String arg1) {
			super(arg1);
			this.arg1 = arg1;
		}
		...
		public IMeta getMeta() {
			...
			PropertyDescription propertyDescription = nodetype.getProperties().get(arg1);
		...
		public Object getValue(Object arg0) {
			...
			if (object instanceof Map) {
				...
				for (String s:ma.keySet()) {
					ModelNode n=new ModelNode(ma.get(s), NodeKind.this);
					nodes.add(n);
					n.setKey(s);
					nodes.add(n);
				}
		...
		protected void doSet(Object target, Object object) throws IllegalAccessException {
			...
			listener.updated(m, object, arg1);
		}
	}
