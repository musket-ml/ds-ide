...
public class MusketProjectNameAndLocationWizardPage extends AbstractNewProjectPage implements
...
//    protected Button noSrcFolder;
     ...
     */
    public MusketProjectNameAndLocationWizardPage(String pageName) {
        super(pageName);
        setTitle("Musket Project");
        setDescription("Create a new Musket Project.");
        setPageComplete(false);
        initialLocationFieldValue = Platform.getLocation();
        customLocationFieldValue = ""; //$NON-NLS-1$
        setImageDescriptor(SWTImageManager.getDescriptor("new_musket"));
...
//        });
    ...
    private void createProjectDetails(Composite parent) {
        ...
        details = new PyProjectPythonDetails.ProjectInterpreterAndGrammarConfig(
                () -> {
                    ...
                    setPageComplete(MusketProjectNameAndLocationWizardPage.this.validatePage());
                    return null;
                },
                () -> {
        ...
        details.radioIron.setVisible(false);
        details.radioIron.setVisible(false);
    ...
    public IWizardPage getNextPage() {
        MusketProjectWizard wizard = (MusketProjectWizard) getWizard();
