 ...
 * 
 */
public class MusketProjectExistingSourcesWizardPage extends AbstractNewProjectPage
     ...
     * </p>
     */
    public MusketProjectExistingSourcesWizardPage(String pageName) {
        super(pageName);
    ...
    public boolean isPageComplete() {
        ...
        if (((MusketProjectWizard) getWizard()).projectPage.getSourceFolderConfigurationStyle() != IWizardNewProjectNameAndLocationPage.PYDEV_NEW_PROJECT_EXISTING_SOURCES) {
            return true;
        }
