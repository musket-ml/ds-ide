...
public class SentenceCountAnalizer extends AbstractAnalizer implements IAnalizer<AbstractTextDataSet>,IColumnDependentAnalizer{
	...
	public String getName(IColumn c) {
		return "Group by "+c.caption()+" sentence count";
	}
